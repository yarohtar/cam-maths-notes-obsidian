A regular formal language or a Type 3 language ([[The Chomsky Hierarchy]]) is produced by rules $A\to a$ and $A\to aB$ where $A,B$ are variables and $a$ is a termination symbol. ([[Grammars]])
### Proposition
