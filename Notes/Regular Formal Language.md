A regular formal language or a [[The Chomsky Hierarchy#Type 3|Type 3]] language is produced by rules $A\to a$ and $A\to aB$ where $A,B$ are variables and $a$ is a termination symbol. ([[Grammar]])
### Proposition
